...
//function execute query with optional parameters - returns array of results
...
//function execute non-query (INSERT, UPDATE, DELETE) - returns affected rows or last insert id
