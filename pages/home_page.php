    ...
    <div class="page-banner">
        ...
        <div class="container">
            ...
            <div class="d-inline-block bg-white rounded-pill shadow-sm">
                <a href="product" class="text-decoration-none text-dark fw-bold text-uppercase small"><button class='btn btn-light px-4 py-2 text-bold' style="border-radius: 20px;font-weight:bold;">To Order <i class="bi bi-arrow-right ms-1"></i></button></a>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center mb-4 mb-xl-5 gx-xl-5">
            <div class="col-12 col-md-12 col-xl-6 mb-4 mb-xl-0">
                <div class="img-wrapper">
                    <img src="<?= BASE_URL ?>assets/img/home/image_01.png" alt="Interior Design" class="story-img shadow-sm">
                </div>
            </div>
            <div class="col-12 col-md-12 col-xl-6">
                <div class="ps-xl-4 text-secondary">
                    ...
                    <div class="d-inline-block rounded-pill shadow-sm">
                        <a href="<?= BASE_URL ?>about-us" class="text-decoration-none text-dark fw-bold text-uppercase small"><button class='btn btn-dark px-4 py-3 text-bold' style="border-radius: 20px;font-weight:bold;">About Us <i class="bi bi-arrow-right ms-1"></i></button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row g-3 g-md-4">
                        ...
                        <div class="card product-card h-100 border p-3 p-md-4 shadow-sm bg-white">
                            <div class="row align-items-center h-100">
                                <div class="col-5 col-md-4 col-xl-4">
                                    <a href="<?= BASE_URL ?>product/<?= $prod["product_slug"] ?>">
                                ...
                                <div class="col-7 col-md-8 col-xl-8 ps-3 ps-md-4 overflow-hidden">
                                    <a class="d-block fw-bold font-serif mb-2 text-truncate text-decoration-none text-dark" href="<?= BASE_URL ?>product/<?= $prod["product_slug"] ?>"><?= $prod["product_title"]; ?></a>
                                    ...
                                    <div class="d-flex flex-column flex-md-row flex-wrap align-items-start align-items-md-center justify-content-between mt-auto">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="<?= BASE_URL ?>product/<?= $prod["product_slug"] ?>" class="btn btn-dark btn-sm rounded-0 px-3 py-1 text-uppercase" style="font-size: 12px;">Buy</a>
                ...
                <div class="text-center mt-5">
                    <a href="<?= BASE_URL ?>product" class="btn btn-outline-dark rounded-pill px-5 py-2 fw-bold text-uppercase">
